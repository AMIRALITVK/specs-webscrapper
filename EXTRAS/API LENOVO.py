...
# payload = "{'country':'gb','channel':'APOS','source':null,'couponNumber':null,'language':'en','serialNumber':{},'machineType':{},'machineTypeModel':'','brand':'TPG'}".format(serial_num, machine_type)
